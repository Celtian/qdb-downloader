...
- 📤 Export selected leagues, unassigned teams, and descendants with independent visibility and field-name presets as separate JSON, nested Single JSON, or RFC 4180 CSV.
