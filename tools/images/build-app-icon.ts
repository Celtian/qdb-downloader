...
const buildAppIcon = async (): Promise<void> => {
  ...
  const sourcePath = join(root, 'resources', 'icons', 'qdb-downloader-source.png');
  ...
  await Promise.all([
    writeOutput(join(root, 'resources', 'icons', 'qdb-downloader.png'), appPng),
    writeOutput(join(root, 'resources', 'icons', 'qdb-downloader.ico'), appIco),
    writeOutput(join(root, 'projects', 'electron', 'public', 'qdb-downloader.png'), appPng),
